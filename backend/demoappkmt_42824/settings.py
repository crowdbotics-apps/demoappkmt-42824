"""
Django settings for demoappkmt_42824 project.
...
ROOT_URLCONF = 'demoappkmt_42824.urls'
...
WSGI_APPLICATION = 'demoappkmt_42824.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoappkmt_42824 API",
    "DESCRIPTION": "API documentation for demoappkmt_42824 App",
    "VERSION": "v1",
}
